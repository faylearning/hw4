...
protected:
    ...
    void balHelper(Node<Key, Value>* root, bool &bal, int &height) const;
...
template<typename Key, typename Value>
void BinarySearchTree<Key, Value>::balHelper(Node<Key, Value>* root, bool &bal, int &height) const{
